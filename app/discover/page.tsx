  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pt-24 pb-12">
          ...
          <p className="mt-6 max-w-2xl text-gray-400 leading-8">
            Browse highly rated titles, community favorites and
          ...
          >
            {games.map((game, index) => (
              ...
              >
                ...
                >
                  <div className="relative overflow-hidden rounded bg-zinc-900 shadow-xl ring-1 ring-white/5 transition-all duration-300 group-hover:ring-blue-500/50">
          ...
          <div className="mt-14 flex flex-col items-center gap-6">
            ...
            <div className="flex items-center gap-4 rounded-full border border-white/10 bg-zinc-950 px-4 py-3 shadow-xl">
              ...
              <button
                ...
                disabled={page === 1}
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-30"
              >
                <ChevronLeft size={18} />
              </button>
            ...
            <p className="text-center text-sm text-gray-500">
              {active === "critics"
                ? "Games ranked using Metacritic scores."
                : "Games ranked using RAWG community ratings."}
            </p>
